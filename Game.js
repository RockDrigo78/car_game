// VARIABLES
var currPosY = 0; //RED CAR
var currPosX = 125; //RED CAR
var currPosMyCarY = 530; // YELLOW CAR car
var currPosMyCarX = 125; // YELLOW CAR
var speed = 1;
var dist = 0;
var timer = 0;
var collision = 0;
...
var Car = document.getElementById("car");  // RED CAR
var	Road = document.getElementById("road");  // ROAD
var MyCar = document.getElementById("myCar"); // YELLOW CAR
...
function incomingTraffic(){
	...
	else if(currPosY<=600){ // TO MOVE THE RED CAR DOWN
...
//FUNCTION TO MOVE YELLOW CAR LEFT
...
//FUNCTION TO MOVE YELLOW CAR RIGHT
...
//FUNCTION TO MOVE YELLOW CAR UP
...
//FUNCTION TO MOVE YELLOW CAR DOWN
